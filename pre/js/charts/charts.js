...
export function initChart() {
    //Lectura de datos
    d3.csv('https://raw.githubusercontent.com/EnvejecimientoEnRed/informe_perfil_mayores_2022_demografia_1_6/main/data/poblacion_anciana_ccaa.csv', function(error,data) {
